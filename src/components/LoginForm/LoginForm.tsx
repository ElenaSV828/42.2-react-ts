...
function LoginForm() {
  ...
  //ПОКАЗЫВАЕ ошибки, при введние какого то пароля и нажатие кнопки
  //typeError('Password must be number') если хотим указать красивуб ошибку
...
// .min(18, 'Min 18')
  ...
  return (
    <LoginFormWrapper onSubmit={formik.handleChange}>
